    ...
    <div className="min-h-screen bg-background text-foreground overflow-hidden relative transition-colors duration-300">
      ...
      <nav className="relative z-10 flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
        <div className="flex items-center gap-2">
          <img src="/src/assets/logo.png" alt="AgentCommand Logo" className="h-10 w-auto object-contain" />
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/signup">
            <Button className="shadow-lg shadow-primary/20 transition-all hover:scale-105">Get Started</Button>
          </Link>
        </div>
      </nav>
      ...
      <main className="max-w-7xl mx-auto px-8 py-20 lg:py-32 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8" style={{ transform: `translateY(${scrollY * 0.2}px)` }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/signup">
                <Button size="lg" className="h-14 px-8 text-lg shadow-xl shadow-primary/20 transition-all hover:scale-105">
          ...
          <div className="relative perspective-1000">
            ...
            <img 
              ...
              className="relative rounded-2xl shadow-2xl border border-border/50 backdrop-blur-sm transition-transform duration-100 ease-out dark:opacity-80"
              style={{ 
        ...
        <div className="mt-32 grid md:grid-cols-3 gap-8">
          <div className="p-8 rounded-2xl bg-card border border-border hover:shadow-xl hover:shadow-primary/5 transition-all hover:-translate-y-1">
